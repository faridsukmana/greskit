<?php
	function pm_tasklist(){
		...
		//-------set id pada handson----------
		$setid = "[{data:'Check_List_No',className: 'htLeft'},{data:'Check_List_Name',className: 'htLeft'},{data:'Task',className: 'htLeft'},{data:'Form_Name',className: 'htLeft'}"._USER_EDIT_SETID_._USER_SPAREPART_SETID_."]";
		//-------get data pada sql------------
