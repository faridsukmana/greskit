<?php
	function worder(){
			...
			if(_DELETE_) $width = "[200,400,200,300,150,150,200,200,200,200,200,200,200,80,80]";
			else $width = "[200,400,200,300,150,150,200,200,200,200,200,200,200,80,80]";
			//==========Timuraya================
			if ($_SESSION['userID'] !='') {
				//-------get id pada sql -------------
				...
				//==========Old================
				//$sethead = "['Work_Order_No','Asset_No','Asset_Name','Work_Type','Work_Status'"._USER_EDIT_SETHEAD_._USER_DELETE_SETHEAD_.",'Work_Priority','Work_Trade','Requested_Date','Required_Date','Plan_Date_Start','Plan_Date_End','Actual_Date_Start','Actual_Date_End','Requestor','Problem_Desc','Cause_Description','Action_Taken','Prevention_Taken']";
				//-------set id pada handson----------
				//$setid = "[{data:'Work_Order_No',renderer: 'html',className: 'htLeft'},{data:'Asset_No',className: 'htLeft'},{data:'Asset_Name',className: 'htLeft'},{data:'Work_Type',className: 'htLeft'},{data:'Work_Status',renderer: 'html',className: 'htLeft'}"._USER_EDIT_SETID_._USER_DELETE_SETID_.",{data:'Work_Priority',className: 'htLeft'},{data:'Work_Trade',className: 'htLeft'},{data:'Receive_Date',className: 'htLeft'},{data:'Required_Date',className: 'htLeft'},{data:'Estimated_Date_Start',className: 'htLeft'},{data:'Estimated_Date_End',className: 'htLeft'},{data:'Actual_Date_Start',className: 'htLeft'},{data:'Actual_Date_End',className: 'htLeft'},{data:'Requestor',className: 'htLeft'},{data:'Problem_Desc',className: 'htLeft'},{data:'Cause_Description',className: 'htLeft'},{data:'Action_Taken',className: 'htLeft'},{data:'Prevention_Taken',className: 'htLeft'}]";
				
				//-------set header pada handson------
				//==========Timuraya================
				$sethead = "['Work_Order_No','Problem Description','Asset_No','Asset_Name','Work_Type','Section','Requested_Date','Required_Date','Plan_Date_Start','Plan_Date_End','Actual_Date_Start','Actual_Date_End','Work_Status'"._USER_EDIT_SETHEAD_._USER_DELETE_SETHEAD_."]";
				//-------set id pada handson----------
				$setid = "[{data:'Work_Order_No',renderer: 'html',className: 'htLeft'},{data:'Problem_Desc',className: 'htLeft'},{data:'Asset_No',className: 'htLeft'},{data:'Asset_Name',className: 'htLeft'},{data:'Work_Type',className: 'htLeft'},{data:'Work_Trade',className: 'htLeft'},{data:'Receive_Date',className: 'htLeft'},{data:'Required_Date',className: 'htLeft'},{data:'Estimated_Date_Start',className: 'htLeft'},{data:'Estimated_Date_End',className: 'htLeft'},{data:'Actual_Date_Start',className: 'htLeft'},{data:'Actual_Date_End',className: 'htLeft'},{data:'Work_Status',renderer: 'html',className: 'htLeft'}"._USER_EDIT_SETID_._USER_DELETE_SETID_."]";
				//-------get data pada sql------------
				...
				/*$sethead = "['Work_Order_No','Asset_No','Asset_Name','Work_Type','Work_Status'"._USER_EDIT_SETHEAD_._USER_DELETE_SETHEAD_.",'Work_Priority','Work_Trade','Requested_Date','Required_Date','Plan_Date_Start','Plan_Date_End','Actual_Date_Start','Actual_Date_End','Requestor','Problem_Desc','Cause_Description','Action_Taken','Prevention_Taken']";
				//-------set id pada handson----------
				$setid = "[{data:'Work_Order_No',renderer: 'html',className: 'htLeft'},{data:'Asset_No',renderer: 'html',className: 'htLeft'},{data:'Asset_Name',className: 'htLeft'},{data:'Work_Type',className: 'htLeft'},{data:'Work_Status',renderer: 'html',className: 'htLeft'}"._USER_EDIT_SETID_._USER_DELETE_SETID_.",{data:'Work_Priority',className: 'htLeft'},{data:'Work_Trade',className: 'htLeft'},{data:'Receive_Date',className: 'htLeft'},{data:'Required_Date',className: 'htLeft'},{data:'Estimated_Date_Start',className: 'htLeft'},{data:'Estimated_Date_End',className: 'htLeft'},{data:'Actual_Date_Start',className: 'htLeft'},{data:'Actual_Date_End',className: 'htLeft'},{data:'Requestor',className: 'htLeft'},{data:'Problem_Desc',className: 'htLeft'},{data:'Cause_Description',className: 'htLeft'},{data:'Action_Taken',className: 'htLeft'},{data:'Prevention_Taken',className: 'htLeft'}]";*/
               ...
               if(isset($_REQUEST['stepwork'])){
				...
				$data_svc = '
							...
							<div class="row">
								<div class="col">
									<div class="alert alert-primary" role="alert">
									  Equipment Classification : '.$eq_class.'
									</div>
								</div>
								<div class="col">
									<div class="alert alert-secondary" role="alert">
									  Part Classification : '.$sp_class.'
									</div>
								</div>
							</div>
				...
				$content .= '<div class="easyui-tabs" style="width:800px;height:500px;margin:auto">
							...
							<fieldset><div class="card-header text-center">Work Order</div>
								<div class="row">
									...
									<div class="col">
										<div class="alert alert-danger" role="alert" style="margin-bottom:0px;">
										  <span class="name">Work Status : </span>'.combo_je(array(COMWOSTAT,'wostat','wostat','80%','',$resultnow[15])).'
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col">
