<?php
	function get_library(){
		$content = '
			...
			<!--------------Jquery UI Min 1.11.4 ---------------->
			<link rel="stylesheet" type="text/css" href="'._ROOT_.'template/startbootstrap/vendor/jquery/jquery-ui.css">
			<script src="'._ROOT_.'template/startbootstrap/vendor/jquery/jquery-ui.min.js" type="text/javascript"></script>
