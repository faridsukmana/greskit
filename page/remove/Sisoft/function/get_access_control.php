<?php
	...
	if(_INSERT_){
		...
		else if(strcmp($_REQUEST['page'],'area')==0) DEFINE('_USER_INSERT_','  <span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_AREA.ADD.'">Add</a></span>');
		else if(strcmp($_REQUEST['page'],'plant')==0) DEFINE('_USER_INSERT_','  <span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_PLANT.ADD.'">Add</a></span>');
	}else{
	...
	if(_VIEW_){
		...
		if(strcmp($_REQUEST['page'],'asscat')==0) DEFINE('_USER_VIEW_','<span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_ASSCAT.'">View</a></span>'); 
			...
			DEFINE('_USER_VIEW_','<span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_ASSETS.'">View</a></span> <span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_ASSETS.TREE.'">Tree</a></span>'); 
			...
			DEFINE('_USER_LOG_','<span><a class="btn btn-outline-success  btn-rounded btn-fw" href="'.PATH_ASSETS.HISTORY.'&rowid='.$_REQUEST['rowid'].'&type=log">Log Data</a></span>');			
		...
		else if(strcmp($_REQUEST['page'],'area')==0) DEFINE('_USER_VIEW_','<span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_AREA.'">View</a></span>');
		else if(strcmp($_REQUEST['page'],'plant')==0) DEFINE('_USER_VIEW_','<span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_PLANT.'">View</a></span>');
	}else{
		DEFINE('_USER_VIEW_',''); 
	...
	if(_EDIT_){
		...
		if(strcmp($_REQUEST['page'],'assets')==0){
			//==========Level 0===================//
			if ($_SESSION['groupID']=="GROUP181120025602" OR $_SESSION['groupID']=="GROUP201103104941"){
