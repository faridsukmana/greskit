...
########################################################## KHUSUS HALAMAN WEB#############################################################
	...
	if(_ACCESS_){	
		...
		//------ LOCATION ------------------
			...
			//-------set header pada handson------
			$sethead = "['Location ID','Location No','Location Description','Department Desc','Location Information','Remark 1','Remark 2','Remark 3'"._USER_EDIT_SETHEAD_._USER_DELETE_SETHEAD_."]";
			//-------set id pada handson----------
			...
			if(isset($_REQUEST['add'])){
				...
				if(isset($_REQUEST['post'])){
					if(!empty($_REQUEST['locno']) && !empty($_REQUEST['locdes']) && !empty($_REQUEST['depdes'])){
						...
						$name = gen_mysql_head($querydat);
						//-------set header pada handson------
						$sethead = "['Location ID','Location No','Location Description','Department Desc','Location Information','Remark 1','Remark 2','Remark 3'"._USER_EDIT_SETHEAD_."]";
						//-------set id pada handson----------
