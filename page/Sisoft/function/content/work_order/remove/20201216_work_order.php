	...
	function worder(){
			...
			if(isset($_REQUEST['add'])){
               ...
               if(isset($_REQUEST['stepwork'])){
				...
				//--- Jika grup adalah administrator dan status adalah close maka ---
				if(($_SESSION['groupID']!="GROUP181120033150" AND $statusid_res=="WS000020") OR (($_SESSION['groupID']=="GROUP201103104941" OR $_SESSION['groupID']=="GROUP181120025602") AND $statusid_res=="WS000014")){
					$submit = '';
				}else{
								...
								<div class="row">
									...
									<div class="col">
										<div class="alert alert-danger" role="alert" style="margin-bottom:0px;">
											<div class="row">
												<div class="col">
													<span class="name">Current Status : </span>'.text_je(array('ktiga',$status_res,'false','style="width:80%;height:22px" disabled')).'
												</div>
												<div class="col">
