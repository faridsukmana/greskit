<?php
	function worder(){
			...
			//-------set lebar kolom -------------
			if(_DELETE_) $width = "[200,300,150,150,80,80,200,200,200,200,200,200,200,200,200,200,400,400,400,400]";
			else $width = "[200,300,150,150,80,200,200,200,200,200,200,200,200,200,400,400,400,400]";
			if ($_SESSION['userID'] !='') {
				//-------get id pada sql -------------
				...
				$sethead = "['Work_Order_No','Asset_Name','Work_Type','Work_Status'"._USER_EDIT_SETHEAD_._USER_DELETE_SETHEAD_.",'Work_Priority','Work_Trade','Requested_Date','Required_Date','Plan_Date_Start','Plan_Date_End','Actual_Date_Start','Actual_Date_End','Requestor','Problem_Desc','Cause_Description','Action_Taken','Prevention_Taken']";
				//-------set id pada handson----------
