...
########################################################## KHUSUS HALAMAN WEB#############################################################
	...
	if(_ACCESS_){	
		...
		//========Halaman contoh penggunaan Highchart=======
			...
			$qorder = 'SELECT COUNT(*) FROM work_order WHERE WorkTypeID<>"WT000002" AND Hidden="no"'; $result = mysql_exe_query(array($qorder,1)); $resultnow=mysql_exe_fetch_array(array($result,1));$count_order=$resultnow[0];
			$content = '
			<div class="row">
			...
			$width = "[100,150,200,200,450]";
			$field = gen_mysql_id(NOTPLANPERFORMED);
			$name = gen_mysql_head(NOTPLANPERFORMED);
			$sethead = "['WO','Assign To','Work_Type','Work Status','Description']";
			$setid = "[{data:'WO',className: 'htLeft'},{data:'Assign_To',className: 'htLeft'},{data:'Work_Type',className: 'htLeft'},{data:'Work_Status',className: 'htLeft'},{data:'Description',className: 'htLeft'}]";
							...
							<table id="his-breakdown" class="table table-bordered" style="width:100%">
							  <thead>
								<tr>
									...
									<th colspan="6" style="text-align: center;"> Breakdown Unschedule </th>
							...
							<table id="his-calculation" class="table table-bordered" style="width:100%">
							  <thead>
								<tr>
									...
									<th colspan="2" style="text-align: center;"> Total Downtime </th>
									<th colspan="2" style="text-align: center;"> MTBF </th>
									<th colspan="2" style="text-align: center;"> MTTR </th>
								</tr>
								<tr>
									<th>Day</th>
									<th>Hour</th>
			...
			//=======2nd ROW ========
			$content .= get_js_graph(array(ALL_PLANT_MTBF_DAY,'3d-pie','ALL PLANT MTBF (DAYS)','Percent MTBF','mtbfday','450','450','typequery1',PATH_INDEX_PAGE,'MTBF'));
			$content .= get_js_graph(array(ALL_PLANT_MTBF_HOUR,'3d-pie','ALL PLANT MTBF (HOUR)','Percent MTBF','mtbfhour','450','450','typequery1',PATH_INDEX_PAGE,'MTBF'));
			//=======3rd ROW ========
			$content .= get_js_graph(array(ALL_PLANT_MTTR_DAY,'3d-pie','ALL PLANT MTTR (DAY)','Percent MTTR','mttrday','450','450','typequery1',PATH_INDEX_PAGE,'MTTR'));
			$content .= get_js_graph(array(ALL_PLANT_MTTR_HOUR,'3d-pie','ALL PLANT MTTR (HOUR)','Percent MTTR','mttrhour','450','450','typequery1',PATH_INDEX_PAGE,'MTTR'));
			...
			$content .= get_js_graph(array(WOBACKLOG,'3d-pie','WO BACKLOG','Percent Work Order','wobacklog','300','360','typequery1',PATH_INDEX_PAGE,'Total Work Order'));
			...
			$content .= '
				<div class="col-lg-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> ALL PLANT MTBF (DAY)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="mtbfday"></div>
				...
				<div class="col-lg-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> ALL PLANT MTBF (HOUR)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="mtbfhour"></div>
				...
				<div class="col-lg-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> ALL PLANT MTTR (DAY)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="mttrday"></div>
				...
				<div class="col-lg-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-table fa-fw"></i> ALL PLANT MTTR (HOUR)
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="mttrhour"></div>
