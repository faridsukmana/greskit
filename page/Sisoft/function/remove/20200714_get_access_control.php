<?php
	...
	if(_INSERT_){
		...
		else if(strcmp($_REQUEST['page'],'employ')==0) DEFINE('_USER_INSERT_','  <span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_EMPLOY.ADD.'">Add</a></span>  <span><a href="'.PATH_EMPLOY.UPLOAD.'">Upload</a></span>');	
		...
		else if(strcmp($_REQUEST['page'],'pmchek')==0) DEFINE('_USER_INSERT_','  <span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_PMCHEK.ADD.'">Add</a></span>');
		else if(strcmp($_REQUEST['page'],'pmsche')==0) DEFINE('_USER_INSERT_','  <span><a class="btn btn-outline-primary btn-rounded btn-fw" href="'.PATH_PMSCHE.ADD.'">Add</a></span>');
