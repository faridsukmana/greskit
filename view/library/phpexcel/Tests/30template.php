...
foreach($data as $r => $dataRow) {
	...
	echo $objPHPExcel->getActiveSheet()->setCellValue('B'.$row, $dataRow['title']);
	echo $objPHPExcel->getActiveSheet()->setCellValue('C'.$row, $dataRow['price']);
	echo $objPHPExcel->getActiveSheet()->setCellValue('D'.$row, $dataRow['quantity']);
